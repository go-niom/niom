...
// categories table
var MySqlCreateCategoriesTable = `CREATE TABLE categories (
  cat_id int(2) NOT NULL,
  cat_title varchar(235) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;`

// comment table
var MySqlCreateCommentTable = `CREATE TABLE comment (
...
// post table
var MySqlCreatePostTable = `CREATE TABLE post (
...
// users table
var MySqlCreateUsersTable = `CREATE TABLE users (
...
var MySqlBlogPostInsert = `INSERT INTO post (post_id, post_category_id, post_title, post_author, post_date, post_image, post_content, post_tags, post_comment_count, post_status)
               VALUES (1, 1, 'java', 'dfghjkl', '2020-03-07', 'java.png', '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis aliquid atque, nulla? Quos cum ex quis soluta, a laboriosam. Dicta expedita corporis animi vero voluptate voluptatibus possimus, veniam magni quis!</p>\r\n', 'AI,machine', 12, 'published'),
...
var MySqlBlogUserInsert = `INSERT INTO users (user_id, username, user_password, user_firstname, user_lastname, user_email, user_image, user_role, rant_solt)
              VALUES (20, 'opt6@lpu.com', '123', 'Suraj', 'jhaguukghv', 'event123@admin.com', 'java.png', 'admin', ''),
